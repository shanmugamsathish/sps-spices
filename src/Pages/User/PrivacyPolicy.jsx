...
import { PRIVACY_POLICY } from "../../lib/constant";
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        >
          ...
          <div className="mt-8 space-y-6">
            {PRIVACY_POLICY?.POLICIES.map((item, index) => (
              <div
                key={index}
              ...
              >
                <div
                  className="flex items-center justify-center h-9 w-9 rounded-lg font-semibold text-white"
