...
function AmazonProducts() {
  ...
  return (
    ...
    <div className="max-w-xl mx-auto p-4 border-b border-gray-300">
      <h1 className="text-2xl font-bold mb-4 text-center" style={{ color: theme.colors.text.primary }}>Amazon Products</h1>
      ...
      <p className="mt-2 text-sm text-gray-500 text-center">
        Paste the Amazon product URL above to fetch product details.
      </p>
    </div>
    <TopSellingProducts key={refreshKey} marketplace="amazon" />
    </div>
  );
}
