...
import { X, Search, HeartPlus, ShoppingCart, CircleUserRound, CircleUserRoundIcon, TruckIcon, UserRoundPenIcon, LogOutIcon, Menu } from 'lucide-react';

function IconsSections({ isSearchOpen, setSearchQuery, handleSearch, setIsSearchOpen, searchQuery, dispatch, setProducts, getAllProducts, navigate, ROUTES, cartItemsCount, user, setShowUserMenu, userMenuRef, setIsEditCustomerModalOpen, setIsDialogOpen, toggleMenu, isMenuOpen, showUserMenu }) {
  return (
    <div
