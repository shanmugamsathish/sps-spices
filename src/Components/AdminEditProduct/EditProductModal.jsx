...
function EditProductModal({ productId, isOpen, onClose, onUpdate }) {
  ...
  const handleSubmit = useCallback(
    ...
    [formData, variants, options, images, productId, onUpdate, onClose, dispatch]
  );
